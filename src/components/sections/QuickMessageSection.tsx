...
const translations = {
  ...
  sectionSubtitle: { en: 'Help us improve Stibar! Send us your suggestions or feedback.', it: 'Aiutaci a migliorare Stibar! Inviaci i tuoi suggerimenti o feedback.', de: 'Helfen Sie uns, Stibar zu verbessern! Senden Sie uns Ihre Vorschläge oder Ihr Feedback.', pl: 'Pomóż nam ulepszyć Stibar! Prześlij nam swoje sugestie lub opinie.', fr: 'Aidez-nous à améliorer Stibar ! Envoyez-nous vos suggestions ou commentaires.', es: '¡Ayúdanos a mejorar Stibar! Envíanos tus sugerencias o comentarios.' },
